...
QUOTE_ASSETS = ['BTC', 'XBTC', 'XCP', 'PEPECASH', 'BITCRYSTALS', 'FLDC', 'RUSTBITS', 'SCOTCOIN', 'DATABITS', 'BITCORN']  # define the priority for quote asset
MARKET_LIST_QUOTE_ASSETS = ['BITCORN', 'DATABITS', 'SCOTCOIN', 'RUSBITS', 'FLDC', 'BITCRYSTALS', 'PEPECASH', 'XCP', 'XBTC', 'BTC']  # define the order in the market list
